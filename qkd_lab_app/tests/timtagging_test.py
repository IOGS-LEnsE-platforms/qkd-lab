...
# extraction des raw data et �criture sur fichier texte
#
...
# d�finition de fonction propre au time tagging
...
def main():
    ...
    while min(nData_A, nData_B, nData_C, nData_D) < max(N_SAMPLE, nSampleToRecovered_B, nSampleToRecovered_C,
                                                        nSampleToRecovered_D):
    ...
    if ret < 0:
        print(" -> failed to close communication\n")
    else:
